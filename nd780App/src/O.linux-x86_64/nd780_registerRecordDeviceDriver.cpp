...
/* Generated from ../O.Common/nd780.dbd */
...
int nd780_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics-R3.16.2/heidenhain-nd780-epics-ioc";
...
/* nd780_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"nd780_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    nd780_registerRecordDeviceDriver(*iocshPpdbbase);
}
